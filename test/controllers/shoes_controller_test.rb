...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { name: @shoe.name, price: @shoe.price, replacement_mileage: @shoe.replacement_mileage, url: @shoe.url }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { name: @shoe.name, price: @shoe.price, replacement_mileage: @shoe.replacement_mileage, url: @shoe.url }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
